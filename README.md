...
[^2]: <https://github.com/ju1-eu/N-Fahrzeugtechnik.git>
...
```
# HTTPS oder SSH
HTTPS: https://github.com/ju1-eu/N-Fahrzeugtechnik.git
SSH: git@github.com:ju1-eu/N-Fahrzeugtechnik.git
...
git remote add origin https://github.com/ju1-eu/N-Fahrzeugtechnik.git
...
```
git clone https://github.com/ju1-eu/N-Fahrzeugtechnik.git
```
